...
public class GlobalConstants {
    ...
    public final static String DOWNLOAD_DIR =  System.getProperty("user.dir") + "/src/test/downloads/";
    public final static String SERVER_DB_DIR = System.getProperty("user.dir") + "/src/test/server/";
